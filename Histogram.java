...
public class Histogram {
	...
	public static BufferedImage drawHist(int []hist) {
		int size = 300;
        ...
        g2d.drawLine(25, 250, 285, 250); 
        g2d.drawString("0", 0, 250+10);
	    g2d.drawLine(25, 250, 25, 5); 	 	
        ...
        for(int i=0; i<hist.length; i++) {  
            ...
            g2d.drawLine(25 + offset + i, 250, 25 + offset + i, 250-frequency);  
        } 
        g2d.drawString("Max:"+String.valueOf(max), 5, 250-max*rate); 
